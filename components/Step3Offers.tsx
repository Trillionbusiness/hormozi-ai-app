...
const OfferCard: React.FC<{ offer: GeneratedOffer, title: string, onPreviewAsset: (item: OfferStackItem) => void, isStatic?: boolean }> = ({ offer, title, onPreviewAsset, isStatic = false }) => (
...
const Step3Offers: React.FC<Step3OffersProps> = ({ offer1, offer2, onPreviewAsset, isStatic = false }) => {
  return (
    <section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <OfferCard offer={offer1} title="Offer Idea 1" onPreviewAsset={onPreviewAsset} isStatic={isStatic} />
            <OfferCard offer={offer2} title="Offer Idea 2" onPreviewAsset={onPreviewAsset} isStatic={isStatic} />
        </div>
    </section>
  );
};
